		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#project0deneme-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project0deneme-display": {
								"semanticObject": "project0deneme",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project0deneme",
									"url": sap.ui.require.toUrl("project0deneme")
								}
							}
						}
					}
